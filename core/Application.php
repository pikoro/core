	...
	public function __construct(array $urlParams=array()){
		...
		$container->registerService('AuthController', function (SimpleContainer $c) {
			return new AuthController(
				$c->query('AppName'),
				$c->query('Request'),
				$c->query('OC\Authentication\ClientLogin\IClientLoginCoordinator'),
				$c->query('URLGenerator'),
				$c->query('UserSession')
			);
		});
		...
		$container->registerService('OC\Authentication\ClientLogin\IClientLoginCoordinator', function (SimpleContainer $c) {
			return $c->query('ServerContainer')->query('OC\Authentication\ClientLogin\IClientLoginCoordinator');
		});
	}
